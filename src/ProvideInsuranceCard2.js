...
class ProvideInsuranceCard2 extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      PolicyNumber:"", 
      InsuranceName:"",
      FrontPreview:localStorage.getItem("insurance_secondry_img_front"),
      BackPreview:localStorage.getItem("insurance_secondry_img_back")
  ...
  componentDidMount() {
    console.log("AppointmentID2=" + localStorage.getItem("insurance_secondry_img_front"));
    console.log("AppointmentID2=" + localStorage.getItem("insurance_secondry_img_back"));
            ...
            >
              ...
              <FormControl>
                <input
                  ...
                  name="image_side"
                  id="image_side"
                  value="Secondary_Insurance_Front"
                ></input>
                <input
                  type="hidden"
                  name="file_type_id"
            ...
            > <Grid item xs={12}>
                ...
                <FormControl>
                  <input
                    ...
                    name="image_side"
                    id="image_side"
                    value="Secondary_Insurance_Back"
                  ></input>
                  <input
                    type="hidden"
                    name="file_type_id"
...
export default withStyles(useStyles)(ProvideInsuranceCard2);
