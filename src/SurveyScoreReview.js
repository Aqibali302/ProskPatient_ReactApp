...
class SurveyScoreReview extends React.Component {
  constructor(props) {
    super(props);
        ...
        (json) => {
          ...
          if (json.success === "1") {
            ...
            this.setState({
              ...
              Hip_Score: parseInt(json.hoos_value),
...
<Card style={{ width: "98%" }}>
          ...
          <Typography
                  ...
                  {this.state.ProblemAreaId=="3" || this.state.ProblemAreaId=="2" ?<div></div>:<Grid>
                   <Grid container spacing={2}>
                    <Grid item xs={12} sm={12}>
                      <Typography
                        variant="h6"
          ...
          <Typography
                  ...
                  {this.state.ProblemAreaId=="3" || this.state.ProblemAreaId=="1"?<div></div>:
                  <Grid>
                    <Grid container spacing={2}>
                    <Grid item xs={12} sm={12}>
                      <Typography
...
export default withStyles(useStyles)(SurveyScoreReview);
